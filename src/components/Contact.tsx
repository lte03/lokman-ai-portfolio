          ...
          <div className="flex flex-wrap justify-center gap-4">
            {contacts.map(c => (
              <a
                ...
                aria-label={c.label}
                className="group flex items-center gap-3 rounded-[24px] border border-white/10 bg-white/[0.04] px-6 py-4 font-medium text-text-primary transition-all duration-300 hover:-translate-y-1 hover:border-accent-from/40 hover:shadow-[0_18px_45px_rgba(0,0,0,0.22)]"
              >
                <span>{c.icon}</span>
